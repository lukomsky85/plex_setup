# plex_setupВот **готовое описание для GitHub-репозитория**, которое вы можете использовать, если вы выложите этот скрипт как проект на GitHub. Оно профессиональное, информативное и понятное для пользователей.
